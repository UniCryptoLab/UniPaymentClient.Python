...
class ApiClient(object):
    ...
    def __call_api(
        ...
        header_params['Authorization'] = 'Hmac {}'.format(hmac_digest)
    ...
    def sanitize_for_serialization(self, obj):
        ...
        if isinstance(obj, dict):
            ...
            obj_dict = {obj.attribute_map[attr]: getattr(obj, attr)
                        for attr, _ in six.iteritems(obj.field_types)
    ...
    def __deserialize_model(self, data, klass):
        ...
        if not klass.field_types and not self.__hasattr(klass, 'get_real_child_model'):
            return data
        ...
        if (isinstance(instance, dict) and
                klass.field_types is not None and
                isinstance(data, dict)):
            for key, value in data.items():
                if key not in klass.field_types:
                    instance[key] = value
